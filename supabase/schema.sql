...
-- ============================================================================
-- Defence-in-depth (v29)
-- ============================================================================
-- Member/family consistency: RLS validates family_id membership but not that
-- member_id points INTO that family — reject the inconsistency outright.
...
-- Shared fixed-window rate limiter for the AI serverless endpoints (service
-- role only — the per-instance in-memory limiter is just the fast path).
