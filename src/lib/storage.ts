 ...
 */
const PREFIX = 'hp:';
const SEED_VERSION = 12; // …8=live-mode-empty-defaults, 9=db-wipe, 10=page-flags+email, 11=virtual-pet, 12=fictional-demo-family (no real family PII in the bundle)
...
export const DEMO_EVENTS: CalendarEvent[] = [
  ...
  },
  {
    ...
    description: null,
    start_at: '2010-02-14T00:00:00.000Z',
    end_at: '2010-02-14T23:59:00.000Z',
    all_day: true,
    location: null,
    category: 'social',
    member_ids: ['m-maya'],
  ...
  },
  {
    id: 'e9',
    family_id: 'fam-harper',
    title: "Finn's birthday",
    description: null,
    start_at: '2012-06-01T00:00:00.000Z',
    end_at: '2012-06-01T23:59:00.000Z',
    all_day: true,
    location: null,
    category: 'social',
    member_ids: ['m-finn'],
  ...
  },
  {
    ...
    description: null,
    start_at: '2015-11-20T00:00:00.000Z',
    end_at: '2015-11-20T23:59:00.000Z',
    all_day: true,
    location: null,
    category: 'social',
    member_ids: ['m-zoe'],
...
export const DEMO_CHORES: Chore[] = [
  stdChore({
    ...
    title: 'Make your bed',
    description: null,
    assigned_to: ['m-maya', 'm-finn', 'm-zoe'],
    frequency: 'daily',
    weekdays: [],
    payout: { stars: 2 },
  ...
  // Rotated: Maya & Finn take turns emptying the dishwasher each day
  {
    id: 'c-2',
    family_id: 'fam-harper',
    title: 'Empty dishwasher',
    description: 'Put everything away properly',
    assigned_to: ['m-maya', 'm-finn'],
    frequency: 'daily',
    weekdays: [],
    payout: { stars: 5 },
    active_from: daysAgoISO(30),
  ...
  // Roster role: bins person rotates weekly between Maya & Finn
  {
    id: 'c-5',
    family_id: 'fam-harper',
...
export const DEMO_HABIT_CHECKINS: HabitCheckIn[] = [
  // Maya reading — 4-day streak
  checkIn('hc-1', 'h-1', 'm-maya', 1),
  checkIn('hc-2', 'h-1', 'm-maya', 2),
  checkIn('hc-3', 'h-1', 'm-maya', 3),
  checkIn('hc-4', 'h-1', 'm-maya', 4),
  // Finn piano — yesterday only (rebuilding streak)
  checkIn('hc-5', 'h-2', 'm-finn', 1),
  // Zoe teeth — solid streak going
  checkIn('hc-6', 'h-3', 'm-zoe', 1),
  checkIn('hc-7', 'h-3', 'm-zoe', 2),
  checkIn('hc-8', 'h-3', 'm-zoe', 3),
  // Alex walks — most days
  checkIn('hc-9', 'h-4', 'm-alex', 1),
  checkIn('hc-10', 'h-4', 'm-alex', 3),
];
