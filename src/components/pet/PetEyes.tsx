...
export const PetEyes = forwardRef<PetEyesHandle, Props>(function PetEyes(
  ...
  if (mood === 'sleeping') {
    ...
    return (
      <g>
        <path
          d={`M ${leftEyeX - eyeR * 0.9} ${eyeY + eyeR * 0.2} Q ${leftEyeX} ${eyeY - eyeR * 0.7} ${leftEyeX + eyeR * 0.9} ${eyeY + eyeR * 0.2}`}
          fill="none"
          stroke="#201c18"
          strokeWidth="2.5"
          strokeLinecap="round"
        />
        <path
          d={`M ${rightEyeX - eyeR * 0.9} ${eyeY + eyeR * 0.2} Q ${rightEyeX} ${eyeY - eyeR * 0.7} ${rightEyeX + eyeR * 0.9} ${eyeY + eyeR * 0.2}`}
          fill="none"
          stroke="#201c18"
          strokeWidth="2.5"
          strokeLinecap="round"
  ...
  return (
    <g>
      ...
      >
        ...
        <path
          d={`M ${leftEyeX - eyeR} ${eyeY} Q ${leftEyeX} ${eyeY + eyeR * 0.6} ${leftEyeX + eyeR} ${eyeY}`}
          fill="none"
          stroke="#201c18"
          strokeWidth="1.5"
          strokeLinecap="round"
      ...
      >
        ...
        <path
          d={`M ${rightEyeX - eyeR} ${eyeY} Q ${rightEyeX} ${eyeY + eyeR * 0.6} ${rightEyeX + eyeR} ${eyeY}`}
          fill="none"
          stroke="#201c18"
          strokeWidth="1.5"
          strokeLinecap="round"
